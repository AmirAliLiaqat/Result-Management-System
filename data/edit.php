                    ...
                    <form action="" method="post">
                        <div class="row my-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="stuId" id="" class="form-control" placeholder="e.g 1190">
                            </div><!--col-md-6-->
                            <div class="col-md-6">
                                <label for="class" class="form-label">Class :</label>
                                <input type="text" name="class" id="" class="form-control" placeholder="e,g 9th, 10th, 1st">
                            </div><!--col-md-6-->
                        </div><!--row-->
                        <div class="row my-2">
                            <div class="col-md-6">
                                <label for="fname" class="form-label">First Name :</label>
                                <input type="text" name="fname" id="" class="form-control" placeholder="e.g Aslam">
                            </div><!--col-md-6-->
                            <div class="col-md-6">
                                <label for="lname" class="form-label">Last Name :</label>
                                <input type="text" name="lname" id="" class="form-control" placeholder="e,g Ali">
                            </div><!--col-md-6-->
                        <div class="row my-2">
                            <div class="col-md-12">
                            <label class="sr-only" for="inlineFormInputGroup">Student Email :</label>
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" id="" class="form-control" placeholder="e.g my@email.com">
                                </div>
                            </div><!--col-md-12-->
                        </div><!--row-->
                        <div class="row my-2">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="eng" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                            <div class="col-md-3">
                                <label for="urdu" class="form-label">Urdu :</label>
                                <input type="number" name="urdu" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                            <div class="col-md-3">
                                <label for="maths" class="form-label">Maths :</label>
                                <input type="number" name="maths" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                            <div class="col-md-3">
                                <label for="pak-study" class="form-label">Pak Study :</label>
                                <input type="number" name="pak-study" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                        </div><!--row-->
                        <div class="row my-2">
                            <div class="col-md-3">
                                <label for="isl" class="form-label">Islamiyat :</label>
                                <input type="number" name="isl" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                            <div class="col-md-3">
                                <label for="phy" class="form-label">Physics :</label>
                                <input type="number" name="phy" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                            <div class="col-md-3">
                                <label for="chem" class="form-label">Chemistry :</label>
                                <input type="number" name="chem" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                            <div class="col-md-3">
                                <label for="bio" class="form-label">Biology :</label>
                                <input type="number" name="bio" id="" class="form-control" min="0" max="100">
                            </div><!--col-md-3-->
                        </div><!--row-->
                        <div class="row my-2">
                            <div class="col-md-3">
