        ...
        <div class="container my-5 p-2" style="background:#ccc; border-radius:15px">
            ...
            <form action="" method="post">
                ...
                <div class="row px-3 py-2">
                    ...
                    <div class="col-md-6">
                        <input type="password" name="currentPassword" id="id_currentPassword" class="form-control" value="<?php echo $row['password']; ?>" required>
                        <i class="far fa-eye"  id="togglecurrentPassword" style="margin-left: 500px; cursor: pointer;"></i>
                    </div><!--col-md-6-->
                </div><!--row-->
                <div class="row px-3 py-2">
                    <div class="col-md-6">   
                    ...
                    <div class="col-md-6">
                        ...
                        <i class="far fa-eye"  id="togglePassword" style="margin-left: 500px; cursor: pointer;"></i>
                    </div><!--col-md-6-->
                </div><!--row-->
                <div class="row px-3 py-2">
                    <div class="col-md-6">   
                    ...
                    <div class="col-md-6">
                        ...
                        <i class="far fa-eye"  id="toggleCpassword" style="margin-left: 500px; cursor: pointer;"></i>
                    </div><!--col-md-6-->
                </div><!--row-->
